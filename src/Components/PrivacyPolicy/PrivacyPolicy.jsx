...
function PrivacyPolicy() {
  ...
  useEffect(() => {
    document.title = "BY — Privacy Policy";
  }, []);
    ...
    <>
      ...
      <div className={s.PrivacyPolicy}>
        ...
        <div className={s.mainContainer}>
          ...
          <p>
            Affiliate means an&nbsp;entity that controls, is&nbsp;controlled by&nbsp;or&nbsp;is&nbsp;under common control with a&nbsp;party, where &laquo;control&raquo; means ownership of&nbsp;50% or&nbsp;more of&nbsp;the shares, equity interest or&nbsp;other securities entitled to&nbsp;vote for election of&nbsp;directors or&nbsp;other managing authority.
          </p>
          <p>
            Company (referred to&nbsp;as&nbsp;either &laquo;the Company&raquo;, &laquo;We&raquo;, &laquo;Us&raquo; or&nbsp;&laquo;Our&raquo; in&nbsp;this Agreement) refers to&nbsp;Bogdanov Yan.
          </p>
          <p>
          ...
          <p>
            Website refers to&nbsp;Bogdanov Yan, accessible from http://www.bogdanovyan.site
          </p>
          <p>
          ...
          <p>
            Cookies can be&nbsp;&laquo;Persistent&raquo; or&nbsp;&laquo;Session&raquo; Cookies. Persistent Cookies remain on&nbsp;Your personal computer or&nbsp;mobile device when You go&nbsp;offline, while Session Cookies are deleted as&nbsp;soon as&nbsp;You close Your web browser. You can learn more about cookies on&nbsp;TermsFeed website article.
          </p>
          <p>
          ...
          <p>
            We&nbsp;will let You know via email and/or a&nbsp;prominent notice on&nbsp;Our Service, prior to&nbsp;the change becoming effective and update the &laquo;Last updated&raquo; date at&nbsp;the top of&nbsp;this Privacy Policy.
          </p>
          <p>
          ...
          <p>
            By&nbsp;email: Hi@bogdanovyan.site
          </p>
          <p>
            By&nbsp;visiting this page on&nbsp;our website: http://www.bogdanovyan.site/contact
          </p>
